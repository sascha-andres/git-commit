...
type (
	...
	Configuration struct {
		...
		FirstLineExpressions      []string `yaml:"subject"`                  // FirstLineExpressions is a list of regular expressions to check the first line
		...
		ReplaceExpressions        []string `yaml:"replacements"`             // ReplaceExpressions is a list of expressions in the form of find-->replace to make replacements
		...
		firstLineCompiled  []*regexp.Regexp
